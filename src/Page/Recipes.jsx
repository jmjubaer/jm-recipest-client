        ...
        <div>
            <div className="">
                <div className="card card-side items-center bg-amber-500 bg-opacity-50 my-8 border shadow-xl">
                    <figure><img className='rounded-full shadow-md m-5' src={chefPicture}alt="Movie"/></figure>
                    <div className="card-body">
                        ...
                        <span>like : <FaHeart className="text-xl inline-block text-red-500" />  {likes}</span>
