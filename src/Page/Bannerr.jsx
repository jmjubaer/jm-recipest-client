    ...
    return (
        <div>
            <div className="my-5 relative">
                <div className="carousel w-full rounded-3xl h-[500px] ">
                    ...
                    <div id="slide3" className="carousel-item relative w-full">
                        <img src={imag_1} className="w-full" />
                        <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
                        <a href="#slide2" className="btn btn-circle">❮</a> 
                        <a href="#slide1" className="btn btn-circle">❯</a>
                        </div>
                    ...
                    <div className="absolute w-2/3 text-center text-white top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                        <h1 className='text-5xl'>Well come in
                        <span className="text-4xl ms-3">
                            <Link to="/">
